...
public class LoginTestScript {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		addDetailsToLoginForm(driver, "Nandhini", "nandhini@gmail.com", "nandy");// get login data
		addDetailToRegisterForm(driver, "Nandhini@gmail.com", "Nandy", "Nandy");// get register data

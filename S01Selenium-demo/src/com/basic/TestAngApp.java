...
public class TestAngApp {
	...
	private static void addProductToShoppingCartXPath(WebDriver webdriver, String route, String productname,
			String quantity) {
	...
	private static void addProductToShoppingCart(WebDriver webdriver, String route, String productname,
			String quantity) {
		webdriver.get(url + "/" + route);

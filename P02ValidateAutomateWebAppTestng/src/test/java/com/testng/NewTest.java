...
public class NewTest {
	...
	private void addDetailsToLoginForm() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"pass\"]")).sendKeys("nandy");
	...
	private void addDetailToRegisterForm() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("Nandhini@gmail.com");
		driver.findElement(By.xpath("//*[@id=\"psw\"]")).sendKeys("Nandy");
	...
	private void addToCart() throws InterruptedException {
		...
		driver.findElement(By.cssSelector("div.product-item:nth-child(1) > div:nth-child(4) > input:nth-child(2)"))
				.click();
		driver.findElement(By.cssSelector("div.product-item:nth-child(2) > div:nth-child(4) > input:nth-child(2)"))
				.click();
		driver.findElement(By.cssSelector("div.product-item:nth-child(3) > div:nth-child(4) > input:nth-child(2)"))
				.click();
		driver.findElement(By.cssSelector("div.product-item:nth-child(4) > div:nth-child(4) > input:nth-child(2)"))
				.click();
		Thread.sleep(300);
